...
export type CreateSubsciberMutationVariables = Exact<{
  name: Scalars['String'];
  email: Scalars['String'];
}>;


export type CreateSubsciberMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };
...
export const CreateSubsciberDocument = gql`
  ...
  createSubscriber(data: {name: $name, email: $email}) {
    ...
    `;
export type CreateSubsciberMutationFn = Apollo.MutationFunction<CreateSubsciberMutation, CreateSubsciberMutationVariables>;

/**
 * __useCreateSubsciberMutation__
 *
 * To run a mutation, you first call `useCreateSubsciberMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateSubsciberMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createSubsciberMutation, { data, loading, error }] = useCreateSubsciberMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useCreateSubsciberMutation(baseOptions?: Apollo.MutationHookOptions<CreateSubsciberMutation, CreateSubsciberMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateSubsciberMutation, CreateSubsciberMutationVariables>(CreateSubsciberDocument, options);
      }
export type CreateSubsciberMutationHookResult = ReturnType<typeof useCreateSubsciberMutation>;
export type CreateSubsciberMutationResult = Apollo.MutationResult<CreateSubsciberMutation>;
export type CreateSubsciberMutationOptions = Apollo.BaseMutationOptions<CreateSubsciberMutation, CreateSubsciberMutationVariables>;
